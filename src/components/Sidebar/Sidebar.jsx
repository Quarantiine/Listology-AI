...
export default function Sidebar({ navState, navDispatch }) {
	...
	return (
		<>
			{!closeSidebar ? (
				<div
					className={`sidebar todolist-sidebar z-[100] transition-colors duration-300 fixed md:sticky top-0 left-0 min-w-[280px] max-w-[280px] h-full flex flex-col justify-start items-start border-r-2 ${
