		...
		<>
			<div className={`p-7 w-full h-auto ${user.themeColor ? "text-white" : "text-black"}`}>
				<div className="flex justify-bewteen gap-4 items-center w-full">
					...
					<div className="w-fit h-fit relative text-btn" onClick={handleCloseSidebar}>
						{!user.themeColor ? (
				...
				<p className="font-bold text-btn w-fit my-3">All</p>
				<div className="flex flex-col gap-1 justify-start items-start">
					<div className="flex justify-start items-center gap-1 text-btn w-fit">
						<Image
			...
			>
				...
				>
					...
					<div className="flex flex-col justify-start items-start gap-1">
						<p className="text-btn">Settings</p>
						<p className="text-btn">Tutorials</p>
